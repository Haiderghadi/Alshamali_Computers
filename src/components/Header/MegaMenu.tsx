...
// Categories and products data (matching the existing structure)
const categories = [
  {
    id: "laptops",
    name: "Laptops",
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed top-20 left-1/2 transform -translate-x-1/2 z-50 bg-white shadow-2xl border border-gray-100 rounded-lg overflow-hidden w-[800px]"
        >
                  ...
                  {hoveredCategory ? (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <a
                          href={`/shop/category/${hoveredCategory}`}
