  ...
  return (
    <div className="[perspective:1200px] [transform-style:preserve-3d]">
      ...
      >
        ...
        >
          <img
            className="absolute bg-neutral-50 inset-0 w-[120%] h-[120%] object-contain opacity-100 transition-opacity duration-600 ease-in-out"
            style={{
        ...
        >
          <button className="px-6 py-2 w-fit text-black bg-white h-12 border border-transparent text-md flex justify-center items-center rounded-2xl hover:shadow-lg transition duration-200 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]">
            {button}
          </button>
        </article>
      </li>
